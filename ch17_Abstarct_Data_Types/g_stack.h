...
** The array size is given as one of the arguments when the stack is instantiated.
*/

#include <assert.h>

/*
** Macro to generate stack functions and storage for a specific type, suffix, and size.
** Usage:
**     GENERIC_STACK(int, _int_stack, 100);
*/
